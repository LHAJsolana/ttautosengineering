...
On a self-hosted server, `LEAD_STORAGE_PATH` can provide a durable JSONL fallback
outside the public web root when email or webhook delivery is unavailable.
