...
export const ui = {
  en: {
    ...
    footer: {
      ...
      affiliateNote:
        "This site may contain affiliate links. Editorial content remains independent.",
  ...
  nl: {
    ...
    footer: {
      ...
      affiliateNote:
        "Deze site kan affiliatelinks bevatten. De redactionele inhoud blijft onafhankelijk.",
  ...
  ar: {
    ...
    footer: {
      ...
      affiliateNote:
        "قد يحتوي هذا الموقع على روابط تابعة. يبقى المحتوى التحريري مستقلاً.",
